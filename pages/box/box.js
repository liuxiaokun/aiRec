      ...
      success: res => {
        ...
        wx.getFileSystemManager().readFile({
          ...
          success: resp => {
            ...
            wx.request({
              url: 'https://wx.ai.huadong.net/api/detect/base64/ai/1', //路由
              data: {
                "img": resp.data
              },
              method: "POST",
              ...
              success(e) {
                ...
                for (let i = 0; i < array.length; i++) {
                  ...
                  _this.mycanvas.moveTo(rect[0] * scale, rect[1] * scale)
                  _this.mycanvas.lineTo(rect[2] * scale, rect[1] * scale)
                  _this.mycanvas.lineTo(rect[2] * scale, rect[3] * scale)
                  _this.mycanvas.lineTo(rect[0] * scale, rect[3] * scale)
                  _this.mycanvas.lineTo(rect[0] * scale, rect[1] * scale)
